...
**** Đo đạc các thông số trên siêu âm tim 2D
     ...
     - Mặt cắt từ mỏm
       ...
       3. Các đường kính của thất P
          - Mặt cắt 4 buồng từ mỏm
          - Đo cuối tâm trương
          - Đường kính trục dọc: Từ đỉnh đến trung điểm nối vòng van 3 lá
          - Đường kính ngang đáy thất P: đường kính ngang lớn nhất ở 1/3 dưới (vùng đáy) thất P (có thể không phải là vòng van)
            + [[./img/echoCardiography_RVDiameters.jpg]]
...
** Chu chuyển tim và ECG
  ...
  2. R
     - Co đồng thể tích <- *bắt đầu tâm thu* (R-S)
...
*** Đánh giá chức năng tâm trương thất trái
    1. Bốn thông số cần đo đạc
       - Septal e', lateral e': 7cm/s, 10cm/s (cũ), mới 6cm//s, 7cm/s
       - E/e' trung bình 14, septal 15, lateral 13
       - LAVi 34ml/m2
       - TRVmax 2.4m/s
    2. Các bước đánh giá
       - Step 1: Đánh giá thư giãn thất T: Đo e' (sep <=6, lat <=7, agv <=6.5)
       - Step 2: Đánh giá tái cấu trúc LA/LV và tăng áp lực nhĩ T
         + Avg E/e' >14
         + LARS (strain của nhĩ T) <=18%
         + E/A <=0.8 hoặc >=2
         + LAVi > 34ml/m2
       - Step 3: đánh giá chức năng tâm trương giảm khi có e' giảm và ít nhất 1 thông số trong step 2 || hoặc có từ 2 thông số trong step 2 trở lên
    3. Lưu đồ
       - [[./img/echoCardiography_diaDisFuncASE2025.jpg]]
       - Các bước theo lưu đồ 
         + Xem 3 thông số: e', E/e', TRVmax
         + Cả 3 bình thường -> normal
         + Cả 3 bất thường -> E/A < 2 độ 2, E/A>2 độ 3
         + Chỉ e' bất thường: E/A <=0.8 độ 1
         + Còn lại -> tính LAVi < 34 Normal LAP; nếu LAVi >34 tăng LAP -> E/A < 2 độ 2, E/A >=2 độ 3
*** Van nhân tạo
    1. Hẹp Van DMC nhân tạo
       - Chênh áp tối đa: Ở van ĐMC thì vận tốc máu trong LVOT đã đến 1.5m/s (>1m/s) cần dùng phương trình Bernouli đầy đủ (delta_P = 4(V2^2-V1^2)
       - Chênh áp trung bình
       - Diện tích mở van hiệu quả: Bình thường EOA Van DMC > 1cm2/m2, hai lá >1.2-1.3cm2/m2
       - Bất xứng van nhân tạo - bệnh nhân (PPM)
         + EOA >0.85 cm2/m2: PPM không ý ngĩa huyết động
         + EOA 0.65-0.85 cm2/m2: PPM trung bình
         + EOA <0.65: PPM nặng
       - DVI (dimensionless index) (>=0.3) và AT (aceleration time) (<100ms). Lưu đồ tiếp cận: 
         + Vmax qua van < 3m/s thường bình thường
         + Vmax > 3m/2: [[./img/echoCardiography_DVI_and_AT_inProstheticAo.jpg]]
       - Trên lâm sàng thường dùng 2 chỉ số: chênh áp vad EOA/BSA [[./img/echoCardiography_prostheticAoStenosis.jpg]]
       - Nguyên nhân hẹp: van mở tốt hay không? vôi hóa? huyết khối?
    2. Hở van DMC nhân tạo
       - 
    3. Hẹp van 2 lá nhân tạo
       - [[./img/echoCardiography_hepVan2laNhantao.jpg]]
    4. Tóm tắt
       - Cần đo Vmax, max PG, mean PG, VTI LVOT, VTI CW -> EOA, DVI. AT.  
** Sách Echo made easy
   1. Normal variants
      - Normal structure
...
** Catherine_M._Otto_Textbook_of_Clinical_Echocardiography
   ...
   3. Normal color doppler flow pattern
      ...
      - RVOT
        + Màu thường đồng nhất xanh do vận tốc thấp và nông hơn LVOT
      - LA inflow
        + "Vortex" dòng từ van 2 lá -> thành bên -> vách -> LVOT (mid dia)
        + Dòng đảo ngược ở BN thay van 2 lá
        + [[./img/echoCardiography_CDI_LA_inflow.jpg]]
      - RA inflow
        + Dòng màu tương tự LA inflow
      - Atrial inflow
        + Right superior pulvn in A4C
        + Dòng màu đỏ 2 pha trên CDI giúp xác định vị đúng vị trí để đo doppler xung
        + Khoảng 20-30% người bình thường có lỗ bầu dục (SA cản quang), trên SAT thành ngực chỉ # 5%.
      - Hở van sinh lý
        + Hở van 2 lá, 3 lá nhẹ có thể thấy 50-80% người bình thường
        + Hở phổi (a narrow red “flame” in diastole) 70-80% người bình thường
        + *Ngượi lại, hở chủ trên CDI chỉ 5% ở người bình thường*
   4. The Echo exam: Core elements
      1. 
...
*** LV
    ...
    6. Diastolic function
       - [[./img/echoCardiography_fillingPatterns.jpg][filling_patterns]]
*** RV
    1. Is the RV dilated?
       - RVD1 <42mm
       - RVD2 <35mm
       - RVD3 <86mm
       - RVOT prox < 35mm (bài trên mạng)
       - RVOT dis < 27 (bài trên mạng)
    2. If large, is RV active or hypokinetic?
       - Active: ASD, TR, PR
       - Hypokinetic: Pulmonary hypertension (PE), RV infarction, myopathy, end stage vale disease
    3. Quantification of systolic function using long-axis measurements
       - TAPSE: |BT >16mm
       - Tissue Doppler systolic velocity: |BT >10cm/s
    4. Is there RV hypertrophy?
       - Wall thickness >5mm
       - Mặt cắt dưới sườn: đo tại tips của van 3 lá
    5. Is there left-side disease?
    6. Is there evidence of a shunt above the RV?
       - ASD. Sinus venosus defect or partial anomalous pulmonary venous drainage
    7. Is there TR and PR?
    8. Estimate pulmonary artery pressure
       - Estimating RA pressure
         + IVC <=2.1 && Collapse >50% => +3mmHg
         + IVC <=2.1 && Collapse <50% || IVC >2.1 && Collapse >50% => +8mmHg
         + IVC >2.1 && Copllapse <50% => +15mmHg
       - Estimating PA systolic pressure
         + TR Vmax => chênh áp = 4(Vmax)^2
         + PA systolic pressure = RA pressure + chênh áp. Giả định không có hẹp van ĐMP hoặc RVOT obstruction
       - Estimating PA diastolic pressure
         + PR V_endDiastolic (đo cuối thì tâm trương)=> chênh áp 4V^2. [[./img/echoCardiography_PR.jpg]]
         + PA diastolic pressure = RA pressure + chênh áp
       - Estimating PA mean pressure
         + There are no firm methods so it is recomended that more than one is used
         + 1/3 PA sys pressure + 2/3 PA dia pressure
         + 4 x PR Vmax^2 (đo max chứ không phải cuối tâm trương)+ RA pressure
       - If there is no TR jet
         + Doppler ĐMP có thể giúp gợi ý tính trạng tăng áp ĐMP
         + PW vị trí trung tâm ĐMP chính hoặc giữa vòng van ĐMP. Tránh để quá gần thành động mạch. [[./img/echoCardigraphy_PA_Velocity.jpg]]
         + Đo thời gian bắt đầu - peak velocity
         + |BT >105ms loại trừ tăng áp động mạch phổi
         + |Giảm <80ms gợi ý nhiều có tăng áp động mạch phổi
         + Dấu hiệu khác gợi ý tăng áp ĐMP: TR Vmax >2.8-2.9; Estimate PA sys pressure >35mmHg; PA acceleration time <105ms (mor specific if <80ms); High early or end diastolic PR velocty; (TAPSE <16mm; TDI pulsed <10cm/s; TDI color <6cm/s; giả định không có nhồi máu thất P hoặc bệnh cơ tim)
    9. Mistakes to avoid
       - Áp lực ĐMP tăng theo tuổi và cân nặng. Do đó, áp lực ĐMP tâm thu 35-40mmHg co thể bình thường ở người lớn tuổi hoặc béo phì. 
       - IVC size and collapse không chính xác ở người bệnh có thông khí cơ học 
    10. Bài trên mạng
       - Đánh giá chức năng tâm thu dọc
         + TAPSE >=17
         + Sóng s' >9.5cm/s
         + GLS
       - Đánh giá chức năng tâm thu toàn bộ
         + Chỉ số Tei (RIMP) = (IVRT + IVCT)/ET =(TCO-ET)/ET 
         + FAC >35%
         + RV 3D EF
       - Đánh giá chức năng tâm trương
         + E, A van 3 lá
         + E', A'
    11. Áp lực DMP - BS Nam
       - PAPm > 25 khi nghỉ hoặc > 30mmHg khi gắng sức. Áp dụng cho cả người lớn và trẻ em.
       - Khi SAT dự đoán áp lực dự đoán áp lực thất P đại diện cho áp lực DMP, do đó phải loại trừ tắc nghẽn đường ra thất P.
       - Phân độ PAPs (35 50 70): |BT <=35 |Nhẹ 36-49 |TB 50-69 |Nặng >=70
       - Khi có thông liên thất hoặc PAD: RVSP áp lực thất P (bằng áp lực DMP) = SBP (huyết áp tâm thu đo bằng tay, khi không có tắc nghẽn LVOT) - 4Vmax2 của lỗ thông
*** LA
    - Đường kính LA không đại diện tốt cho hình thái LA
    - Diameter: PLAX < 40mm
    - Area (cm2):|BT <20 |Nhẹ >20 |TB >30 |Nặng >40
    - Vol/BSA (ml/m2): |BT 16-34 |Nhẹ >34 |TB >41 |Nặng >48
*** RA
    - Transverse diameter: |BT <44mm
    - Area: |BT <18
    - Volume: not recommended
*** Cardiomyopathies
**** The dilated left LV
**** The hypertrophied LV
     - A wall thickness >=30mm in any segment is a strong marker for sudden death in HCM
     - Impaired sys func with significant hypertrophy suggests amyloid rather than hypertrophic cardiomyophathy
     - EF <50% in HCM indicate high risk of sudden death
     - Restrictive rather than slow or pseudonormal filling suggest amyloid cardiomyopathy
     - Fixed obstruction LVOT (peaking in early or mid-sys) vs systoic anterior motion of mitral valve (peaking in late sys)
     - Tim vận động viên thường có tăng kích thước buồng tim nhưng chỉ dầy nhẹ vách (<=13mm)
       + Cô Hoa: Tim vận động viên dày <16mm, dày đều, không có rối loạn chức năng tâm trương
     - Mistake to avoid
       + Over reporting a normal subAo septal bulge in the elderly
       + Making a new diagnosis of HCM from the echo alone. This is a clinical diagnosis
       + Mistaking MR jett for LVOT jet on CW
       + Missing a sub aortic membrane as a cause of non-valvar LVOT acceletation and LV hypertrophy
**** Restrictive cardiomyopathy
**** Noncompaction
**** ARVD
     - On echo there must be regional akinesis, dyskinesis (not hypokinesis) or aneurysms
     - Other features [[./img/echoCardiography_ARVD.jpg]]
*** Aortic valve disease
**** Aortic stenosis
     1. Appearance of the valve and aorta
        - Số lá, dày, vôi, di động?
        - Nếu ĐMC 2 lá: Is it anatomical or functional (two cusps fused either partially or fully with a median raphe)? fusion giữa lá trái và phải thường gặp nhất (#60%), thường kèm theo dãn ĐMC và hẹp eo ĐMC (5%). 
     2. Doppler
        - Minimum dataset: Vmax, mean gradient, effective orifice area (EOA)using the continuity equation.
        - CW mặt cắt từ mỏm và ít nhất một mặt cắt khác unless the aortic valve disease is obviously mild shown by:
          + Mobile cusps
          + Low velocity
          + Normal EF
     3. Đánh giá độ nặng
        - Vmax < 2.5m/s
          + Nếu lá van dày, EF bình thường => dày van ĐMC, không hẹp
        - Vmax >=2.5
          + Vmax(m/s):           |Nhẹ 2.6-2.9 |TB 3.0-4.0 |Nặng >4.0
          + Peak gradient:       |Nhẹ <40     |TB 40-65   |Nặng >65
          + Mean gradient:       |Nhẹ <20     |TB 20-40   |Nặng >40
          + EOA (cont eq) (cm2): |Nhẹ >1.5    |TB 1.0-1.5 |Nặng <1.0
        - Vmax >4.0m/s but EOA >1.0cm2
          + High flow (hở chủ, thiếu máu, anxiety) or
          + Đo sai EOA (PW đo quá gần van ĐMC, LVOT quá lớn)
          + Xem xét Wave form: Dagger or Arch; EOA/BSA; Dimensionless index; Lá van canxi + di động kém?
        - Vmax <4.0m/s but EOA <1.0cm2
          + Low flow
          + Đo sai EOA (PW quá gần LV apex, đo sai LVOT)
          + Xem xét Wave form: Dagger or Arch; EOA/BSA; Dimensionless index; Lá van canxi + di động kém?
        - Low gradient, low flow aortic stenosis. This occurs if:
          + EF thấp. Or
          + LV phì đại kèm khoang LV nhỏ. Ngay cả EF bình thường hoặc cao nhưng stroke volume quá nhỏ và dòng chậm. Or
          + Severe MR or MS. Or
          + Definition: mean gradient <40mmHg && EOA < 1.0cm2 && (EF <40% || SVi <35ml/m2 || flow <200ml/s)
        - Dobutamin stress echocardiography (DSE)
          + Indication: mean gradient <=30-40mmHg && EF <=40%. (ESC 2025: SVi <=35ml/m2 && EF <50%)
     4. General
        - Lượng giá AR
        - Lượng giá các van khác. Hở van 2 lá thứ phát nếu LV dãn
        - Lượng giá áp lực động mạch phổi. Là chỉ dấu tiên lượng xấu. 
        - Phì đại đường ra thất T
        - If the valve looks mildly affected but the velocities are high, consider a subaortic membrane.
**** Aortic regurgitation
     1. Apperance of the valve and aorta
     2. Colour flow mapping
        - Đo tỷ lệ % độ rộng dòng phụt ngược/LOVT diameter, vị trí 5-10mm bên dưới vòng van. Nếu dòng lệch tâm nhiều, chạm vào thành thất hoặc van 2 lá thì phương pháp này không chính xác. Không đo LVOT trên mặt cắt từ mỏm.
        - Vena contracta.
        - [[./img/echoCardiography_ARjet.jpg]]
     3. Continuous wave signal
        - Đo PHT
     4. Flow reversal at the arch
        - Mô tả dòng phụt ngược toàn tâm trương, nửa tâm trường hoặc đầu tâm trương, dùng clour M-mode và PW
        - Dòng phụt ngược thấy được đến đoạn nào của động mạch chủ xuống trên doppler màu
        - [[./img/echoCardiography_flowReversalDesAo.jpg]]
     5. Grade the severity of AR
        - Tỷ lệ độ rộng dòng hở/LOVT và dòng phụt ngược ĐMC xuống là đáng tin cậy nhất
        - Color/LVOT height (%): |Nhẹ <25  |TB 25-64   |Nặng >=65
        - Vena contracta (mm):   |Nhẹ <3   |TB 3-6     |Nặng >6
        - Flow reversal Des Ao:  |Nhẹ ko   |TB đầu dia |Nặng Holodiastolic (EDV > 0.2m/s)
        - PHT (ms):              |Nhẹ >500 |TB 200-500 |Nặng <200
        - CW signal intensity:   |Nhẹ nhạt |TB inter   |Nặng dense
        - PISA không dùng thường quy trong AR
     6. Đánh giá thất T
     7. Chỉ định phẫu thuật
        - Hở chủ nặng và dựa vào thể tích tâm thu, tâm trương thất trái, EF, dãn ĐMC. 
     8. Mistake to avoid
        - Đặt PW quá gần thành ĐMC xuống, có thể tạo xảo ảnh cuối tâm trương (dòng đối xứng trên và dưới baseline), dễ nhầm với dòng phụt ngược (chỉ có dòng trên baseline)
        - Trong hở chủ cấp nên đo thời gian giảm tốc sóng E, <150ms gợi ý nguy cơ cao có decompensation. 
        - KHi có bệnh lý thất T gây tăng áp lực cuối tâm truogn có thể gây giảm PHT, dẫn đến overestimate độ nặng AR
        - Không dùng vena contracta để tính tỷ lệ độ rộng dòng hở/LVOT
        - Không dùng PHT khi chùm tia không song song với dòng hở. AR jet initial peak velocity should be about 4m/s; if much lower, đặc biệt nếu có bidirectional signal, dùng các phương pháp khác. 
*** Mitral valve disease
**** Mitral stenosis
     1. Appearance
        - Almost all MR is *rheumatic* in origin. Show by:
          + Commissural fusion
          + Bowing of the tips
          + Thickening of the leaflet tips
          + Chordal thickening
        - Degenerative calcification in the annulus usually causes no more than moderate stenosis
     2. Planimeter the orifice area
        - Use color Doppler as a guide to the extent of the orifice if this is not obvious on imaging
     3. Continuous wave signal
        - Tính trung bình cộng PHT và mean gradient trong 3-5 chu kỳ nếu có rung nhĩ
        - The Hatle formula: Orifice area = 220/PHT
        - In calcific annular disease, sóng A thường lớn do bệnh lý THA lâu ngày. Có thể ước đoán quá mức độ nặng hẹp van 2 lá khi dùng mean gradient. Thường lá van mỏng và di động tốt, lúc này kích thước lỗ mở van nên dùng để đánh giá độ nặng. 
     4. Assess MR
        - Hở van 2 lá trung bình trở lên không phù hợp sửa van
     5. Đánh giá độ nặng
        - The planimetered orifice area is the most reliable measure in rheumatic disease if performed accurately. 
        - Orifice area by planimetry (cm2): |Nhẹ >1.5 |TB 1.0-1.5 |Nặng <1.0
        - PHT (ms):                         |    <150 |   150-220 |     >220
        - Mean gradient (mmHg):             |    <5   |      5-10 |>10 (15 sau gắng sức)
        - PA pressure (mmHg):               |    <30  |     30-50 |     >50
     6. Examine the right heart
        - Áp lực động mạch phổi tương quan yếu với độ hẹp van 2 lá, là 1 trong những tiêu chuẩn cho chỉ định nong van 2 lá bằng bóng (PAPs >50mmHg at rest)
        - Dãn thất phải kèm giảm động là chỉ dấu tiên lượng kém tốt hơn áp lực động mạch phổi
        - Tricuspid rheumatic involvement is common, but easily missed
     7. Assess the other valves
        - Đánh giá kỹ các van còn lại giúp lên kế hoạch sửa van
        - Hẹp van ĐMC có thể bị underestimated vì dòng chậm do hẹp van lá (hoặc hở van 2 lá)
        - Transmitral PHT bị rút ngắn bất tương xứng so với diện tích mở van nếu hở chủ nặng
     8. Risk of atrial thrombus
        - SA qua thực quản luôn luôn phải thực hiện trước nong van 2 lá
        - Dãn nhĩ trái >50mm or volume >60ml/m2 là tiêu chí dùng kháng đông trên bệnh nhân hẹp van 2 lá + nhịp xoang. 
     9. Is the valve suitale for balloon valvotomy
        - Các đặc điểm đáng tin cậy nhất gợi ý nong van thành công
          + Lá trước di động tốt
          + No more than minor chordal involment
          + No more than mild AR
          + No commissural calcification
          + No LA thrombus (on TOE)
        - Một số trung tâm dùng Wilkins score <=8 gợi ý nong van 2 lá thành công. Tuy nhiên thang điểm này thiếu một số tính chất quan trọng như trên.
     10. Mistakes to avoid
         - Off-axis planimetry of the mitral valve
         - Không tính đến ảnh hưởng của hở 2 lá nặng hoặc hở chủ nặng đến PHT
         - Overestimate độ nặng van 2 lá khi có canxi nặng vòng van ở bệnh nhân có nhịp xoang do sóng A lớn
**** Mitral regurgitation
     1. Appearance
        - Nguyên phát: sa van, hậu thấp, viêm nội tâm mạc nhiễm trùng, SLE,...
        - Thứ phát: Nhồi máu cơ tim, dãn LV
        - Sa van 2 lá
          + Which segments are involved using the Carpentier classification? [[./img/echoCardiography_Carpentier.jpg]]
          + Dòng phụt thường away from prolapse
          + Lá van sa >2mm sau mặt phẳng vòng van trên PLAX, A3C
          + Điểm đóng van bên dưới mặt phẳng vòng van trên A4C
        - Có hạn chế mở van trong thì tâm trương?
          + Giới hạn di động cả 2 tip lá van với bowing of the leaflets trong hậu thấp
          + Dễ nhầm lẫn trong trường hợp giảm mở cả 2 lá van (not just the tip) do giảm cung lượng tim, hoặc giảm di động lá trước van 2 lá do dòng hở chủ
        - Is there restriction of both leaflets during systole (symmetrical tenting)
        - Is there restriction of the posterior leaflet during systole (asymetrical tenting): thường do nhồi máu cơ tim thành dưới, dòng hở hướng ra sau
        - Nếu hình ảnh và di động lá van bình thường:
          + Đo đường kính vòng van: >35(nữ), >40(nam) gợi ý dãn vòng van
          + Kiểm tra thủng van, nứt van
          + Check for commissural prolapse???
     2. Color flow mapping
        - Origin of the jet (vách, giữa hay bên lỗ mở van)
        - Hướng dòng hở
        - Độ rộng dòng hở: vena contracta (trung bình cộng nhiều mặt cắt vuông góc vì dòng phụt thường hình oval hơn là circle) hoặc PISA
          + Cách đo [[./img/echoCardiography_PISAandVC_AR.jpg]]
        - Duration of the jet using M-Mode
            + Toàn tâm thu hoặc chỉ một phần tâm thu
            + Vena contracta hoặc PISA phải được hiểu chỉnh nếu dòng phụt không phải toàn tâm thu???
     3. CW signal
        - "Dagger-shaped" signal is a sign of severe regurgitation
     4. PW
        - Severe MR is suggested by:
          + E >1.5m/s in the absence of MS
          + VTI_transMitral/VTI_subAortic >1.4
        - The estimation of filling pressures using E/E' ratio is not valid in the presence of severe mitral regurgitation
     5. General
        - Chỉ định phẫu thuật (ESC 2025)
          + Symtomatic severe primary MR. I
          + Asymtomatic servere primary MR with EF <=60% or LV dilation (LVESD >=40mm || LVESDi >=20mm/m2). I
          + Asymtomatic servere primary MR with 3/4 (AF + SPAP at rest > 50mmHg + LAVI >=60mL/m2 or diameter >=55mm + concomitant 2nd TR >= moderate). I
          + Asymtomatic servere primary MR with AF or SPAP at rest > 50mmHg or significant LA dilation (LAVI >=60mL/m2 or diameter >=55mm). IIa
     6. Grading
        - VC (mm):    |Nhẹ <3  |TB 3-6.9 |Nặng >=7
        - PSIA quantities
        - EROA (mm2): |Nhẹ <20 |TB 20-39 |Nặng >=40
        - Regur vol:  |Nhẹ <30 |TB 30-59 |Nặng >=60
        - RF(%):      |Nhẹ <30 |TB 30-49 |Nặng >=50
*** Right-side valve disease
**** Tricupid regurgitation
     1. Apperance
        - Trace or mild TR is seen in 80% normal subjects
        - The normal apical displacement of the septal leaflet is up to 15mm
        - Đường kính vòng van bình thường 25-40mm/PLAX, 20-34mm/A4C
        - Dãn vòng van 3 lá >=40mm or >21mm/m2
        - A4C: lá vách + lá trước
        - PLAX: Lá sau + lá vách/trước
        - PSAX: Phụ thuộc mặt cắt
     2. Grading
        - The most useful are the color width and density of the continuous wave signal. 
        - Systolic flow reversal in the hepatic vein and IVC is a specific sign of severe TR
        - Color neck (mm):   |Nhẹ 0  |TB <7   |Nặng >=7
        - PISA radius (mm):  |Nhẹ <5 |TB 6-9 |Nặng >9 (Nyqusit 20-30cm/s)
        - EORA(mm2): not routinely performed |Nặng >=40
        - Regur vol: not routinely performed |Nặng >=45
        - CW signal:         |Nhẹ incomplete |TB low or moderate intensity |Nặng Dense and may be triangle
        - Hepatic vein flow: |Nhẹ normal |TB may be systolic blunting |Nặng systolic reversal
        - [[./img/echoCardiography_TR_CW.jpg]]
     3. Chỉ định phẫu thuật ESC 2025
        - Có chỉ định sửa van bên trái kèm TR trung bình/nặng hoặc TR  nhẹ nhưng dãn vòng van (>=40mm or >21mm/m2)
        - TR nặng kèm rối loạn chức năng RV/LV hoăc tăng áp phổi tiền mao mạch -> *không* phẫu thuật
        - TR nặng có triệu chứng hoặc dãn RV or chức năng RV kém dần *không có* rối loạn chức năng RV/LV hoăc tăng áp phổi tiền mao mạch
**** Tricuspid stenosis
     1. Appearance
        - Ussually rheumatic, may be congenital (Ebstein, tricuspid atresia), carcinoid, fibrosis sencondary to SLE, pacemaker
     2. Recognising tricuspid stenosis
        - Hẹp van 3 lá thường khó nhận biết hơn MS vì ít dày và canxi hóa
        - Dấu hiệu gợi ý:
          + Vmax >1.0m/s (more likely >1.5 m/s) or
          + Mean gradient > 2 mmHg
          + Small RV, large RA
        - Dấu hiệu gợi ý hẹp nặng
          + Mean gradient >= 5mmHg
          + PHT >=190ms
     3. Surgery
        - Chỉ định khi có hẹp nặng kèm triệu chứng hoặc có chỉ định phẫu thuật tim trái
**** Pulmonaryy stenosis and regurgitation
     1. Nguyên nhân
        - Hẹp van ĐMP hầu như luôn luôn là do bẩm sinh. 
        - Hẹp tại van 90%, dưới van 5%, trên van 1%, tại nhánh 5%
     2. Hình thái van
        - An initial clue to the presence of stenosis is turbulent flow in the RV out flow tract during systole on CDI
     3. Có hở phổi không?
        - Trace or mild is normal.
        - Severe PR is suggested by:
          + A wide color jet >7.5mm hoặc >50% RVOT
          + Dòng phụt ngược thấy được đoạn xa hoặc nhánh ĐMP
          + PHT <100mms
          + PR duration/dia duration <0.77
          + Dilated, active RV
          + [[./img/echoCardiography_PR_CDI.jpg]]
          + [[./img/echoCardiography_PR_CW.jpg]]
     4. Chênh áp qua van
        - Gợi ý hẹp nặng
          + Vmax: |Nhẹ <3.0 |TB 3.4-4.0 |Nặng >4.0
          + Mean pressure gradient: |Nặng >50mmHg hoặc có kèm RV dysfunction 
     5. Check the level of the obstruction
     6. Ước lượng áp lực động mạch phổi
     7. Đo lường động mạch phổi
        - RVOT: 18-34mm
        - PV annulus: 10-22mm
        - Main pul: 9-29mm
        - R pul: 7-17mm
        - L pul: 6-14mm
     8. Đánh giá thất phải
     9. Chỉ định can thiệp
     10. Mistakes to avoid
        - Không dùng TR_Vmax đơn thuần để tính PAPS nếu có hẹp phổi hoặc RVOT obstruction. Subtracting the 4(V_pulm)^2 from 4(V_TRmaX)^2 will get a better estimate
*** Pericardial disease
**** Pericardial effusion
     1. Pericardial or pleural
        - [[./img/echoCardiography_periVsPleuEffusion.jpg]]
     2. Size and distribution
        - Size:
          + Trivial: Chỉ thấy thì tâm thu hoặc khu trú nhĩ phải
          + Small: <10mm cuối tâm trương
          + Moderate: 10-20mm cuối tâm trương
          + Large: >20mm cuối tâm trương
        - Distribution: khu trú hay toàn thể?
        - Is there enough fluid in the SC for safe pericardocentesis:
          + Usually >20mm, at least 10mm
        - Tính chất dịch: Echolucent, localized strands (tuberculosis), echodense (Haematomas)
        - Might drainage not feasible?
          + Too small
          + Loculated
          + Echodense
     3. Is tamponade present?
        - Chèn ép tim là chẩn đoán lâm sàng hỗ trợ bởi siêu âm tim
        - Evidence of tamponade
          + IVC >20mm, collapse <50%
          + Fall in aortic (LVOT) or early diastolic mitral vel (E) during inpiration >25%. [[./img/echoCardiography_tamponadePwLVOT.jpg]]
          + Increase in transtricuspid vel on inpiration >40%
          + Prolonged and widespread diastolic RV collapse (lý tưởng là xem được trên M-mode để xác định mốc thời gian chính xác)
          + Lệch vách liên thất sang trái trong thì hít vào
          + Note: /Collapse of RA and RVOT occur before RV collapse and are non-specific signs/
     4. Differential diagnoses
        - 3 chẩn đoán phân biệt chính: TDMP, Fat (thường gặp thành trước hoặc giữa RV và cơ hoành), nang màng ngoai tim
        - Increased left-sided respiratory variation: 
          + Asthma
          + Suy thất P
          + Underfilling
**** Pericardial constriction
     1. Visual assessment
        - Septal bounce: Có thể là dấu hiệu đầu tiên của viêm màng ngoài tim co thắt. [[./img/echoCardiography_septalBounce.jpg]]
        - LA size: Có thể lớn nhẹ hoặc trung bình 2 nhĩ trong  co thắt màng ngoài tim
        - IVC: dãn và không xẹp
     2. Doppler
        - LV filling pattern: restrictive (E:A >2, E deceleration tim <150ms)
        - Respiratory variability (spontaneous respiration): >25%
        - Tissue doppler: Normal sys velocities, normal or raised E' vel. The peak E' may be higher at the septal than the lateral annulus (which becomes tethered to the pericardium)
        - Estimated PA pressure: moderately increased (usually <50mmHg)
        - Hepatic vein flow: Flow reversal is maximal on the first beat after expiration. 
        - Pulmonảy vein flow: S:D >0.65 on inspiration and D giảm >40% on inspiration
     3. Pericardial constriction or restrictive cardiomyopathy?
        - Nhiều nguyên nhân gây co thắt màng ngoài tim cũng có thể gây cơ tim hạn chế. Cần thiết xác định cái nào nổi trội hơn. 
        - The key is that the ventricles are normal in constrictive pericarditis but abnormal in restrictive cardiomyopathy
          + Lateral or septal E':     |Cons >=8cm/s |Res <7cm/s
          + Respiratory variability:  |Cons >25%    |Res <10%
          + LA, RA dilation:          |Mild or mod  |Severe
          + Sepal bounce:             |+            |-
          + Hepatic flow reversal max:|Expiration   |Inspiration
          + PAPs:                     |<50mmHg      |May be >50mmHg
          + [[./img/echoCardiography_constrictiveVsRestrictive.jpg]]
          + [[./img/echoCardiography_constrictiveVsTamponade.jpg]]
     4. Pericarditis
        - Vai trò của siêu âm: loại trừ viêm cơ tim (dãn buồng tim, rối loạn vận động vùng, RL chức năng tâm thu); detect tràn dịch màng tim, tamponade; clue to the diagnosis (eg. valve involement in SLE); rối loạn vận động vùng PB với MI. 
     5. Mistake to avoid
        - Không kiểm tra SC view để đảm bảo lượng dịch đủ an toàn để chọc dò
        - Cẩn tìm septal bounce, dilated IVC, short E DT ở BN có lâm sàng suy tim nhưng kích thước buồng tim bình thường và EF bình thường
        - Tránh nhầm lẫn mỡ màng ngoài tim là TDMT
*** Masses
    1. Facts
       - 2nd tumors are at least 20 times more common than 1st tumors
       - The most common benign 1st tumors are atrial myxoma (70%), papilary fibroelastoma (10%), fibroma and, mainly in infants and children, rhabdomyoma. 
       - The most common 1st malignancies are the sarcomas, especially angiosarcomas, usually arise in the RA. Lymphoma are less common. 
    2. Features of thrombus
       - underlying wall motion abnormality
       - Cleavage plane between thrombus and LV wall
       - Higher density than mycardium
       - Present in more than one view
       - Cause a void on CDI
*** Appendices
    1. Frequency of echocardiography in native valve disease
       - From ASE and ESC 2009-2012
       - [[echoCardiography_valveDiseaseFollowUp.jpg]]
    2. Formulae
       - Bernoulli equation
         + Short: Delta_P = 4(V2)^2
         + Long: Delta_P = 4(V2)^2 - 4(V1)^2
         + V1: Subvalvar vel; V2: Transvalvar vel
         + Short form dùng trong trường hợp vận tốc dưới van << vân tốc qua van như trong trường hợp MS, AS trung bình - nặng (V2 >3m/s); không dùng trong trường hợp AS nhẹ. 
       - Continuity euqation
         + The classical form: EOA = CSA*VTI_subAo/VTI_transAo
         + The modified form: EOA = CSA*V_subAo/V_transAo. chỉ dùng ước tính trong trường hợp có hẹp đáng kể động mạch chủ
       - Pressure half time
         + MOA = 220/T_1/2
         + MOA: effective mitral orifice area (cm2)
         + T_1/2: pressure half time (ms)
         + Chỉ sử dụng trong hẹp trung bình - nặng
       - Stroke vol and cardiac output
         + SV(ml) = CSA*VTI_subAo
         + CO = SV*HR
       - Flow
         + Flow(ml/s) = CSA*VTI_subAo*1000/SET
         + SET: sys ejection time (from opening to closing artifact of the Aortic signal (ms)
       - Systemic vascular resistance
         + SVR = (MAPx80)/CO
         + CO: l/min
         + MAP: mean arterial pressure
         + normal: 800-1200 dyne.sec/cm
       - Estimating normal or high SVR from MR and stroke distance
         + A qualitative estimate of SVR is from: MR Vmax/VTI_subAo.
         + A ratio >0.27: high resitance. <0.2 normal resitance
       - Shunt calculation
         + |Type   |Loaded chamber |Downstream |Upstream
         + |ASD    |RV             |PA         |LVOT
         + |VSD    |LV             |PA         |LVOT
         + |PDA    |LV             |LVOT       |PV
         + The shunt is the ratio of the downstream to the upstream stroke volume
         + Stream for right side: diameter of pul annulus (or main PA) and PW VTI at same location. 
** Mẹo SA
   - RV modified A4C: lên nửa khoảng ls. RV focus: xoay đầu dò để thất phải lớn nhất
   - RV inflow PLAX chếch xuống bên phải
   - RV outflow chếch sang trái ngửa đầu dò
   - PA lên trên 1 khoảng ls ngửa đầu dò. BN cúi đầu. BS Nhật đưa đầu dò xuống 1 khoảng liên sườn. BS Đan hạ đuôi đầu dò
   - Khi siêu am hở van tim cần nghiêng dầu dò để tìm dòng hở lớn nhất
   - SA tiểu nhĩ: hơi đứng đầu dò PSAX, Hình tam giác. có thể xuất hiện giữa mặt cắt van DMC và van 2 lá
   - Chênh áp trong hở van 2 lá nhẹ - trung bình thì Vmãx>4m/s do chênh áp lớn giữa thất T và nhĩ trái
   - SA hở van 3 lá hơi vào trong xương ức + kèm đứng đầu dò
   - Muốn thấy động mạch vành phải thì hạ đuôi đầu dò
   - Mặt cắt đưới sườn: xoay 30 độ để thấy động mạch phổi (giống mặt cắt cạnh ức trục ngắn)
** Bài giảng cô Trang
   1. Các thông số bình thường phải nhớ
      - Dòng hở DMP sinh lý dài 3, diện tích 3
      - Dòng hở van 2 lá, 3 lá sinh lý dài 2, diện tích 2
      - DD < 55
      - Dãn vòng van 2 lá: AM >=35mm, AM/AML >1.3
      - Vmax PA 1.3, Vmax A0 1.7
      - Van 2 lá: Diện tích, đường kính, độ dày, chênh áp tối đa
      - Van 3 lá: không cần
      - Van DMC: diện tích, Vmax, 
      - ĐMP: PÁP, chênh áp tối đa, Vmax
      - Thất trái: thì tâm trương, EF
      - [[./img/echoCardiography_chiSoBinhthuong(1).jpg]] 
      - [[./img/echoCardiography_chiSoBinhthuong(2).jpg][Van 2 lá]]
      - [[./img/echoCardiography_chiSoBinhthuong(3).jpg]]